...
public class FileUtil {
    ...
    */
    ...
    public static String uploadFile(
        ...
        // ex) 상어.png -> asdfasdfasdfa_상어.png
        String newFileName = UUID.randomUUID() + "_" + file.getOriginalFilename();

        // 이 파일을 저장할 날짜별 폴더를 생성
        // C:/spring-prj/upload/2023/05/16/asdfasfdasdf_상어.png
        ...
        // fullPath = C:/ab/upload/2023/05/16/asdf.jpg
        // rootPath = C:/ab/upload/  -> application properties 참고
        return fullPath.substring(rootPath.length());
    }

    /**
     * 루트 경로 받아서 일자별로 폴더 생성 후
     * 루트 경로+날짜 폴더 경로 리턴
    ...
    private static String makeDateFormatDirectory(String rootPath){
        ...
        //05월, 07일 등의 처리를 위해 Integer에서 String으로 변경
