    ...
    <div id="wrap" class="form-container">
        ...
        <div class="buttons">
            <button class="write-btn" type="button"
                    onclick="window.location.href='/board/rewrite?boardNo=${b.boardNo}'">수정
            </button>
            <button class="list-btn" type="button"
                    onclick="window.location.href='/board/list?pageNo=${s.pageNo}&type=${s.type}&keyword=${s.keyword}'">
                목록
            </button>
        </div>
        ...
        function replyRemoveClickEvent() {
            ...
            $replyData.onclick = e => {
                ...
                if (e.target.matches('#replyDelBtn')) {
                    ...
                    // 모발바디의 textarea에 읽은 텍스트 삽입
                    document.getElementById('modReplyText').value = replyText;

                    // 수정완료 처리시 필요한 댓글번호를 modal에 붙여넣기
